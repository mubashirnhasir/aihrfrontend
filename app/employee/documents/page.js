      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">
            Manage your personal and work-related documents
          </p>
        </div>
                ...
                <>
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3-3 3M12 18V12"
                    />
                  </svg>
                  Upload Document
                </>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() =>
                      handleDownload(document._id, document.filename)
                    }
