            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("personalInfo", "phoneNumber", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-md">
                <p className="text-sm text-blue-800">
                  Please review all the information you've provided. Once you
                  complete the onboarding, you'll be able to access your
                  employee dashboard and all portal features.
                </p>
              </div>
            </div>
          </div>
