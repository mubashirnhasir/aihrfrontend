        ...
        <div className="mt-12 bg-blue-50 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-blue-800">
            {activeTab === "ai-screening" ? (
              <>
                <div>
                  <h4 className="font-medium mb-2">🎯 Setup Best Practices</h4>
                  <ul className="space-y-1 list-disc list-inside">
                    <li>Upload detailed job descriptions for better questions</li>
                    <li>Review candidate resumes before starting</li>
                    <li>Ensure quiet environment for accurate evaluation</li>
                    <li>Test audio/video setup beforehand</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-medium mb-2">📊 Interview Optimization</h4>
                  <ul className="space-y-1 list-disc list-inside">
                    <li>10-minute format keeps candidates engaged</li>
                    <li>AI evaluates technical and soft skills</li>
                    <li>Review detailed feedback after completion</li>
                    <li>Use results to guide full interview process</li>
                  </ul>
                </div>
              </>
            ) : activeTab === "job-creator" ? (
