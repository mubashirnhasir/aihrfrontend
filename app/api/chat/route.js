  ...
  try {
    ...
    try {
      ...
      if (
        ...
        lowerPrompt.includes("time off") ||
        lowerPrompt.includes("holiday")
      ) {
        if (lowerPrompt.includes("how") || lowerPrompt.includes("apply")) {
          reply =
            "To apply for leave, go to the Leaves section in your dashboard. You can submit new leave requests, specify dates, and add reasons. Your manager will receive the request for approval.";
        } else if (
          lowerPrompt.includes("balance") ||
          lowerPrompt.includes("remaining")
        ) {
          reply =
            "You can check your leave balance in the Leaves section. It shows your available vacation days, sick leave, and other leave types for the current year.";
        } else {
          reply =
            "Our leave management system helps you request time off, track leave balances, and manage approvals. Visit the Leaves section for all leave-related activities.";
        }
      }
      // Attendance queries
      else if (
        lowerPrompt.includes("attendance") ||
        lowerPrompt.includes("clock") ||
        lowerPrompt.includes("time") ||
        lowerPrompt.includes("hours")
      ) {
        if (
          lowerPrompt.includes("clock in") ||
          lowerPrompt.includes("check in")
        ) {
          reply =
            "To clock in, go to the Attendance section and click the 'Clock In' button. This will record your start time for the day.";
        } else if (
          lowerPrompt.includes("report") ||
          lowerPrompt.includes("history")
        ) {
          reply =
            "You can view your attendance history and generate reports in the Attendance section. It shows your daily hours, overtime, and attendance patterns.";
        } else {
          reply =
            "The Attendance section helps you track work hours, clock in/out, view attendance history, and manage overtime requests.";
        }
      }
      // Asset management
      else if (
        ...
        if (lowerPrompt.includes("request") || lowerPrompt.includes("need")) {
          reply =
            "To request equipment or assets, go to the Assets section and submit a new asset request. Specify what you need and the reason for the request.";
        } else if (
          lowerPrompt.includes("return") ||
          lowerPrompt.includes("give back")
        ) {
          reply =
            "For asset returns, use the Assets section to initiate a return process. Make sure to specify the condition and reason for return.";
        } else {
          reply =
            "The Assets section manages company equipment assignments, requests, and returns. You can track all your assigned assets there.";
        }
      }
      // Document management
      else if (
        ...
        reply =
          "The Documents section allows you to store, organize, and share HR documents. You can upload files, create folders, and manage document access permissions.";
      }
      // Employee information
        ...
        if (lowerPrompt.includes("update") || lowerPrompt.includes("change")) {
          reply =
            "To update your employee profile, contact your HR administrator. They can help modify personal information, contact details, and other profile data.";
        } else {
          reply =
            "Employee information and profiles are managed through the dashboard. You can view team details and organizational structure in the Employees section.";
        }
      }
      // Payroll queries
      else if (
        ...
        reply =
          "For payroll inquiries including salary details, pay stubs, and tax information, please contact your HR administrator. They handle all compensation-related matters.";
      }
      // Career development
      else if (
        ...
        reply =
          "Check out the Career Growth section for development opportunities, skill assessments, training programs, and career path guidance.";
      }
      // AI/automation features
        ...
        reply =
          "Our HRMS includes AI-powered features like employee retention analytics, smart job description generation, and automated email creation. Explore the AI tools in your dashboard!";
      }
      // General greetings
      else if (
        ...
        reply =
          "Hello! I'm your HRMS assistant. I can help you with attendance, leaves, assets, documents, payroll questions, and other HR-related topics. What would you like to know?";
      }
      // Help requests
      else if (
        ...
        if (lowerPrompt.includes("what is") || lowerPrompt.includes("what's")) {
          reply =
            "I can explain HRMS features! Try asking about specific topics like 'what is leave management' or 'what are assets' for detailed information.";
        } else {
          reply =
