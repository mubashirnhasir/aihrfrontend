...
${
  includeAttachments
    ? `- Reference the attachments: ${attachmentDescription}`
    : ""
}
...
3. Appropriate opening and closing`;
    ...
    try {
            ...
            messages: [
              {
                role: "system",
                content:
                  "You are a professional HR email assistant. Generate clear, professional emails for job-related communications. Always provide both a subject line and email body.",
              },
              {
                role: "user",
                content: prompt,
      ...
      const bodyMatch =
        content.match(/(?:Email Body:|Body:)([\s\S]*?)(?:\n\n|$)/i) ||
...
${
  includeAttachments
    ? `Please find the attached ${attachmentDescription}.\n\n`
    : ""
}
