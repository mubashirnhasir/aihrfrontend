...
const NewHires = () => {
  ...
  const filteredEmployees = newHires.filter((emp) =>
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-lg transition-all duration-200 w-[280px]">
      ...
      <div className="space-y-2 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-700">{employee.employeeId || employee._id?.slice(-6) || 'N/A'}</span>
        </div>
      ...
      <div className="mt-4 pt-3 border-t border-gray-100">
        <Link 
          href={`/dashboard/attendance/allemployees?search=${encodeURIComponent(employee.name)}`}
