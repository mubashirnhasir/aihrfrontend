  ...
  useEffect(() => {
    const fetchHolidays = async () => {
      try {
        ...
        console.log(
          `Fetching holidays for ${getCountryName(country)} - using local data`
        );
  ...
  const getFallbackHolidays = () => {
    ...
    const holidaysByCountry = {
      IN: [
        ...
        {
          title: "Eid al-Fitr",
          date: `31 May ${currentYear}`,
          type: "Festival",
        },
        {
          title: "Rath Yatra",
          date: `7 July ${currentYear}`,
          type: "Festival",
        },
        {
          title: "Independence Day",
          date: `15 August ${currentYear}`,
          type: "National Holiday",
        },
        {
          title: "Janmashtami",
          date: `26 August ${currentYear}`,
          type: "Festival",
        },
        {
          title: "Ganesh Chaturthi",
          date: `17 September ${currentYear}`,
          type: "Festival",
        },
        {
          title: "Gandhi Jayanti",
          date: `2 October ${currentYear}`,
          type: "National Holiday",
        },
        {
          title: "Dussehra",
          date: `12 October ${currentYear}`,
          type: "Festival",
        },
        {
          title: "Diwali",
          date: `1 November ${currentYear}`,
          type: "Festival",
        },
        {
          title: "Guru Nanak Jayanti",
          date: `15 November ${currentYear}`,
          type: "Festival",
        },
        {
          title: "Christmas Day",
          date: `25 December ${currentYear}`,
          type: "National Holiday",
        },
      ],
      US: [
        {
          ...
          date: `1 January ${currentYear}`,
          type: "Federal Holiday",
        },
        {
          title: "Martin Luther King Jr. Day",
          date: `20 January ${currentYear}`,
          type: "Federal Holiday",
        },
        {
          title: "Presidents Day",
          date: `17 February ${currentYear}`,
          type: "Federal Holiday",
        },
        {
          title: "Memorial Day",
          date: `26 May ${currentYear}`,
          type: "Federal Holiday",
        },
        {
          title: "Juneteenth",
          date: `19 June ${currentYear}`,
          type: "Federal Holiday",
        },
        {
          title: "Independence Day",
          date: `4 July ${currentYear}`,
          type: "National Holiday",
        },
        {
          title: "Labor Day",
          date: `1 September ${currentYear}`,
          type: "Federal Holiday",
        },
        {
          title: "Columbus Day",
          date: `13 October ${currentYear}`,
          type: "Federal Holiday",
        },
        {
          title: "Veterans Day",
          date: `11 November ${currentYear}`,
          type: "Federal Holiday",
        },
        {
          title: "Thanksgiving",
          date: `27 November ${currentYear}`,
          type: "National Holiday",
        },
        {
          title: "Christmas Day",
      ...
      AE: [
        ...
        {
          title: "Arafat Day",
          date: `6 June ${currentYear}`,
          type: "Islamic Holiday",
        },
        {
          title: "Eid al-Adha",
          date: `7 June ${currentYear}`,
          type: "Islamic Holiday",
        },
        {
          title: "Islamic New Year",
          date: `29 June ${currentYear}`,
          type: "Islamic Holiday",
        },
        {
          title: "Prophet Muhammad's Birthday",
          date: `5 September ${currentYear}`,
          type: "Islamic Holiday",
        },
        {
        ...
        },
        {
          ...
          date: `2 December ${currentYear}`,
          type: "National Holiday",
        },
        {
          title: "UAE National Day Holiday",
          date: `3 December ${currentYear}`,
          type: "National Holiday",
        },
      ],
    };
