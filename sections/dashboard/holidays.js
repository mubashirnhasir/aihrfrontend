...
const Holidays = () => {
  return (
    <div>
        <div className='border border-gray-200 p-4 min-h-[300px] max-h-[400px] rounded-lg'>
            ...
            <div className='flex felx-col gap-2'>
                <div className="card p-4 flex items-start gap-2 bg-gradient-to-b from-[#38D2F5] to-[#0BA5EC] w-full rounded-lg border border-white h-[100px] shadow-[0px_22px_18px_-12px_rgba(0,0,0,0.14)]">
