                ...
                <div key={index} className="space-y-2">
                  ...
                  <div className="flex h-4 bg-gray-200 rounded-full overflow-hidden">
                    ...
                    <div
                      ...
                      style={{
                        width: `${
                          (dept.highRisk / dept.totalEmployees) * 100
                        }%`,
                      }}
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          <div className="text-sm text-gray-600 text-center">
            <span className="font-medium">Note:</span> Predictions are based on
            current risk factors and historical patterns. Regular interventions
            can significantly improve these projections.
          </div>
        </div>
      </div>
    </div>
