...
export const sampleRecommendations = [
  {
    ...
    timeline: '2 weeks',
    category: 'Immediate',
    description: 'Schedule one-on-one meetings with employees showing high risk scores to understand their concerns and develop retention strategies.',
    steps: [
  ...
  },
  {
    ...
    timeline: '1 month',
    category: 'Strategic',
    description: 'Enhance career development opportunities as this is identified as a major risk factor.',
    steps: [
  ...
  },
  {
    ...
    description: 'Address work-life balance concerns through flexible working options.',
    steps: [
